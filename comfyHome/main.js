const client = contentful.createClient({
  space: "nlz2attvswh7",
  accessToken: "xkjfufeYwlC_Z6aTztCpwlzrjqBn8Lmk-eqnngqbcR4"
});
...
class UI {
  ...
  setCartValues(cart) {
    ...
    // convert value from string to number with 2 decimals
  ...
  cartLogic() {
    ...
    cartContent.addEventListener("click", e => {
      if (e.target.classList.contains("remove-item")) {
        ...
        // target the parent of the remove button => card-item, remove from DOM
        ...
        Storage.saveCart(cart);
        this.setCartValues(cart);
        // target the next element from the up button
